 ...
 * of the parameters affected by the reflex response, namely heart rate, right
 * and left ventricular end-systolic compliances, arteriolar resistances, and
...
void elastance_ptr(Data_vector *, Parameter_vector *);
void eqns_ptr(Data_vector *, Parameter_vector *, Reflex_vector *, double *,
              int tiltTestOn, double tiltStartTime, double tiltStopTime);
void fixvolume_ptr(Data_vector *, Reflex_vector *, Parameter_vector *);
double sanode(Data_vector *, Reflex_vector *, Parameter_vector *, double);
void rkqc_ptr(Data_vector *, Reflex_vector *, Parameter_vector *, double,
...
void numerics(Data_vector *, Reflex_vector *, Output_vector *, Parameter_vector *);
void numerics_reset(void);
void rk4_ptr(Data_vector *, Reflex_vector *, Parameter_vector *, double, double *,
             int tiltTestOn, double tiltStartTime, double tiltStopTime);
void numerics_new_ptr(Data_vector *, Reflex_vector *, double, int, double *);

/* Renal and body-fluid funtions*/
void renal_function(Data_vector *, Reflex_vector *, double *, double *, double *, double *, 
double *, double *, double *, double *, double *, double *, double *, double *, double *,
 double, double, double);

void renal_eqns(double *, double *, double *, double *, double *, double *, 
double *, double *, double *, double *, double *, double *, double *, 
double, double);

void rk4_routine(double *, double *, double *, double *, double *, double *, double *, 
double *, double *, double *, double *, double *, double *, double, double, double);

void renal_init(Data_vector *, double *, double *, double *, double *, double *, double *, double *, double *, 
double *, double *, double *, double *);

void renal_write(int, int, double, double *, double *, double *, double *, double *, 
double *, double *, double *, double *, double *);
