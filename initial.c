...
void initial_ptr(Hemo *hemo, Cardiac *cardiac, Micro_r *micro_r, System_parameters *system, Reflex *reflex, Timing *timing)
{
 ...
 // kidney resistance was modified from 4.1 to 5.0, according to kidney module.(Yan Zhang, 2013)
  (*micro_r).r[1][0] = 5.0;  (*micro_r).r[1][1] = 1.0; 
  ...
  (*reflex)[0].set[0][0] = 100.0;  (*reflex)[0].set[0][1] =   3.0;
