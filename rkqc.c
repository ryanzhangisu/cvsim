 ...
 * Last modified   July 13th, 2002
 */
void rk4_ptr(Data_vector *q, Reflex_vector *r, Parameter_vector *c,  double h, double water_flow[11],
             int tiltTestOn, double tiltStartTime, double tiltStopTime)
{
  ...
  eqns_ptr(&q_local, c, &s, water_flow, tiltTestOn, tiltStartTime, tiltStopTime);
  ...
  p_local = q_local;
  eqns_ptr(&p_local, c, &s, water_flow, tiltTestOn, tiltStartTime, tiltStopTime);
  ...
  eqns_ptr(&p_local, c, &t, water_flow, tiltTestOn, tiltStartTime, tiltStopTime);
...
void rkqc_ptr(Data_vector *pres, Reflex_vector *r, Parameter_vector *theta,
              ...
              double *hnext, double water_flow[11], int tiltTestOn, double tiltStartTime, double tiltStopTime)
{
  Data_vector p   = {{0.0}};
  Data_vector q   = {{0.0}};
  Reflex_vector s = {{0.0}};
  ...
  eqns_ptr(pres, theta, r, water_flow, tiltTestOn, tiltStartTime, tiltStopTime); 
  ...
  for (;;) {
    ...
    rk4_ptr(&p, &s, theta, hh, water_flow, tiltTestOn, tiltStartTime, tiltStopTime);    
    ...
    rk4_ptr(&q, &t, theta, h, water_flow, tiltTestOn, tiltStartTime, tiltStopTime);     
    errmax=0.0;
